...
unlocked to sign the Arkhash-Qt.app bundle.
...
allowing somebody to distribute a Arkhash-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the arkhash-qt.exe file inside the installer had not been tampered with.
